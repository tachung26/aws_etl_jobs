...
for year in years:
    ...
    sql_query = f"""
        ...
        CASE WHEN `agency_code` IN ('1', '2', '3', '4', '5', '7', '9') THEN `agency_code` ELSE NULL END AS `agency_code`,
        ...
        CASE WHEN `occupancy` IN ('1', '2', '3') THEN `occupancy` ELSE NULL END AS `occupancy`,
